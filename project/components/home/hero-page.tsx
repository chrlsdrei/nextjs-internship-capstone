...
export function HeroPage() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-platinum-900 to-platinum-800 dark:from-outer-space-500 dark:to-paynes-gray-500">
      ...
      {/* Hero Section */}
      <section className="border-blue-munsell-500/20 border-b bg-outer-space-700">
        <BrokenByDesign title="QuestBoard" />
        <div className="relative z-40 flex justify-center border-blue-munsell-500/20 border-t bg-outer-space-700/95 px-4 py-6 backdrop-blur-md">
