...
export function EmailNotificationSettings({
  ...
  pending: boolean
  state: ActionState<{ enabled: boolean }>
}) {
  return (
    <TechFrameCard contentClassName="px-10 py-9 sm:px-14">
      ...
      <form action={action} className="mt-7 border-cyan-400/25 border-t pt-6">
        <label className="flex cursor-pointer items-start justify-between gap-5 rounded-md border border-cyan-400/25 bg-[#061a34]/75 p-4">
          <span>
