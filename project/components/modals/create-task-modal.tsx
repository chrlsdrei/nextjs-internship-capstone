...
export function CreateTaskModal() {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white dark:bg-outer-space-500 rounded-lg p-6 w-full max-w-2xl mx-4">
        <h3 className="text-lg font-semibold text-outer-space-500 dark:text-platinum-500 mb-4">
