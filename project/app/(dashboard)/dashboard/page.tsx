    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        <div className="flex items-start">
          <div className="flex-shrink-0">
            <div className="w-8 h-8 bg-blue-munsell-500 rounded-full flex items-center justify-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="flex items-baseline">
                    <div className="text-2xl font-semibold text-outer-space-500 dark:text-platinum-500">
                      {stat.value}
                    </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-outer-space-500 rounded-lg border border-french-gray-300 dark:border-paynes-gray-400 p-6">
          <h3 className="text-lg font-semibold text-outer-space-500 dark:text-platinum-500 mb-4">Recent Projects</h3>
          <div className="space-y-3">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="flex items-center justify-between p-3 bg-platinum-800 dark:bg-outer-space-400 rounded-lg"
              >
                <div>
                  <div className="font-medium text-outer-space-500 dark:text-platinum-500">Project {i}</div>
                  <div className="text-sm text-paynes-gray-500 dark:text-french-gray-400">Last updated 2 hours ago</div>
                </div>
                <div className="w-12 h-2 bg-french-gray-300 dark:bg-paynes-gray-400 rounded-full">
                  <div className="w-8 h-2 bg-blue-munsell-500 rounded-full"></div>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* Quick Actions */}
        <div className="bg-white dark:bg-outer-space-500 rounded-lg border border-french-gray-300 dark:border-paynes-gray-400 p-6">
          <h3 className="text-lg font-semibold text-outer-space-500 dark:text-platinum-500 mb-4">Quick Actions</h3>
          <div className="space-y-3">
            <button
              type="button"
              className="w-full flex items-center justify-center px-4 py-3 bg-blue-munsell-500 text-white rounded-lg hover:bg-blue-munsell-600 transition-colors"
            >
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center px-4 py-3 border border-french-gray-300 dark:border-paynes-gray-400 text-outer-space-500 dark:text-platinum-500 rounded-lg hover:bg-platinum-500 dark:hover:bg-paynes-gray-400 transition-colors"
            >
              <Plus size={20} className="mr-2" />
              Add Team Member
            </button>
