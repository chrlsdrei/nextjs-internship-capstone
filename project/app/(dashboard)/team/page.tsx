  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-outer-space-500 dark:text-platinum-500">Team</h1>
          <p className="text-paynes-gray-500 dark:text-french-gray-500 mt-2">Manage team members and permissions</p>
        </div>
        <button
          type="button"
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-blue-munsell-500 rounded-full flex items-center justify-center text-white font-semibold">
                  {member.avatar}
                </div>
                <div>
                  <h3 className="font-semibold text-outer-space-500 dark:text-platinum-500">{member.name}</h3>
                  <p className="text-sm text-paynes-gray-500 dark:text-french-gray-400">{member.role}</p>
                </div>
              </div>
            ...
            <div className="flex items-center text-sm text-paynes-gray-500 dark:text-french-gray-400 mb-4">
